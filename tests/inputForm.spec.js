...
test('TC-03 - Input Form Submit Scenario', async ({ page }) => {
  await page.goto('https://www.lambdatest.com/selenium-playground',{timeout:60000});
  console.log('Starting Test 03: Input Form Submit');
  ...
  await page.fill('#name', 'Hema');
  await page.fill('#inputEmail4', 'Hema@example.com');
  ...
  console.log('Test Scenario 3 is Completed Successfully');
});